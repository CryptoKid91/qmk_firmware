 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn   | <    | GUI  | Alt  |Lower |Space |Enter |Raise | AltGr| Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_FUNCTION] = LAYOUT_planck_grid(
    ...
    _______, KC_LOCK, _______, _______, _______, NEWTAB,  _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT
),
